...
--
-- Name elements uniq; Type CONSTRAINT; Schema public; Owner freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uniq UNIQUE (symbol, name);


--
-- Name properties fkeya; Type FK CONSTRAINT; Schema public; Owner freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkeya FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name properties fkeyt; Type FK CONSTRAINT; Schema public; Owner freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkeyt FOREIGN KEY (type_id) REFERENCES public.types(type_id);
